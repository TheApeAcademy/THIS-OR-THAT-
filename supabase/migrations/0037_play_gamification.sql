-- Phase 5: Play mode & gamification — reputation, achievements, a
-- prediction mode ("what did most people pick?"), a play streak that
-- survives a refresh instead of living in client state, and leaderboard
-- filters by country/friends.
...
-- ============================================================
-- votes: +1 reputation, first-vote achievement
-- ============================================================
...
-- ============================================================
-- streaks: streak_3 / streak_7 achievements alongside the existing
-- daily-login streak bump.
-- ============================================================
...
-- trivia_master achievement at 10 cumulative correct answers.
-- ============================================================
...
-- ============================================================
-- leaderboards: country + friends-only filters (alongside the existing
-- subject filter), using profiles.country from the Settings phase.
-- ============================================================
