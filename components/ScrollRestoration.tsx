 ...
 * back lands where you left off instead of snapping to the top. `style` is
 * passed straight through to the underlying <main> so the caller keeps
 * control of layout-dependent padding (e.g. whether the header is shown).
 */
export function ScrollRestoration({ children, style }: { children: ReactNode; style?: CSSProperties }) {
